          ...
          <div id="wrapper">
            ...
            <div id="body">
              ...
              <div class="floating-menu">
                ...
                <!-- <a class="color" href="api-ref-identity.html">Identity
                  Service APIs</a>
                <a class="color" href="api-ref-compute.html">Compute
                  API</a>
                <a class="color" href="api-ref-image.html">Image
                  Service APIs</a>
                <a class="color" href="api-ref-blockstorage.html"
                  >Block Storage Service API</a>
                <a class="color" href="api-ref-networking.html"
                  >Networking API</a>
                <a class="color" href="api-ref-objectstorage.html"
                  >Object Storage API</a>
                <a class="color" href="api-ref-orchestration.html"
                  >Orchestration API</a>
                <hr/> -->
                <a class="color" href="api-ref.html">API Reference
                  Home</a>
              </div>
